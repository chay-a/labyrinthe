...
while (isPositionDifferentFromGoal()) {
...
function isPositionDifferentFromGoal() {
    return (position[0] != goal[0] && position[1] != goal[1]) || (position[0] == goal[0] && position[1] != goal[1]) || (position[0] != goal[0] && position[1] == goal[1]);
}
